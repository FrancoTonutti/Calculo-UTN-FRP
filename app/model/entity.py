...
from .transaction import TM, SetAttrAction, EntityCreationAction, \
    LoadModelAction, EntityDeleteAction
import uuid
...
class Test2:
    ...
    def draw_line_3d(self, x1, y1, z1, x2, y2, z2, w=1, color=None,
                     parent=None, dynamic=False, set_id=True):
        result = draw.draw_line_3d(x1, y1, z1, x2, y2, z2, w, color,
                                   parent, dynamic)
    ...
    def __setattr__(self, name, new_value):
        ...
        if hasattr(self, name):
            ...
            if unit and (
                    isinstance(new_value, float) or new_value is None):
            ...
            super(Test2, self).__setattr__(name, new_value)
    ...
    def delete(self):
        ...
        if active_transaction:
            ...
            if active_transaction.is_register_enabled():
                action = EntityDeleteAction(self)
                active_transaction.register_action(action)
