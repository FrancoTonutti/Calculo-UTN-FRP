...
class ToonMaker(ShowBase):
    ...
    def __init__(self):
        ...
        # TODO actualizar lente de la camara del shader al cambiar el tamaño de la ventana
        ...
        self.character.loadModel('data/geom/beam')
        self.character.setScale(5)
        self.character.reparentTo(render)
        self.character.loop('win')
        self.character.hprInterval(15, (360, 360, 0)).loop()
